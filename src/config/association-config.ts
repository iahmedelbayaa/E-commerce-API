...
export const create = () => {
  ...
  tables.product.belongsTo(tables.category, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.order.belongsTo(tables.user, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.cart.belongsTo(tables.user, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.orderItem.belongsTo(tables.product, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.orderItem.belongsTo(tables.user, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.orderItem.belongsTo(tables.order, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.cartItem.belongsTo(tables.product, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.cartItem.belongsTo(tables.user, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
  ...
  tables.cartItem.belongsTo(tables.cart, {
    constraints: true,
    onDelete: 'CASCADE',
    foreignKey: { allowNull: false },
  });
